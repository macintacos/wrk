 ...
 * because the number `latency.test.ts` asserts on is **invocation to verdict**, and the runtime's
 * own cold start and this module graph's load are the larger halves of it — both outside the
 * clock of any in-process measurement.
 *
